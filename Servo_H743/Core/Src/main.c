...
/* USER CODE BEGIN PV */
volatile int16_t adc_v[16] __attribute__((section(".bss.ARM.__at_0x64000000")));
// volatile int a[100000] __attribute__((section(".bss.ARM.__at_0xC0000000")));
// volatile int b[100];
/* USER CODE END PV */
...
int main(void) {
  ...
  HAL_Delay(1);
  HAL_GPIO_WritePin(FPGA_RST_GPIO_Port, FPGA_RST_Pin, 1);
  /* USER CODE END 2 */
