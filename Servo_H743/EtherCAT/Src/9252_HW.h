...
#define ECAT_TIMER_INC_P_MS              120000 /**< \brief 312 ticks per ms*/

///////////////////////////////////////////////////////////////////////////////
// Interrupt and Timer Defines

#ifndef DISABLE_ESC_INT
    #define    DISABLE_ESC_INT()           {HAL_NVIC_DisableIRQ(LAN9253_IRQ_EXTI_IRQn);} /**< \brief Disable interrupt source INT1*/
#endif
#ifndef ENABLE_ESC_INT
    #define    ENABLE_ESC_INT()           {HAL_NVIC_EnableIRQ(LAN9253_IRQ_EXTI_IRQn);} /**< \brief Enable interrupt source INT1*/
#endif
