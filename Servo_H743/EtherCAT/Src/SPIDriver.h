...
#define CSLOW() HAL_GPIO_WritePin(SPI6_NSS0_GPIO_Port, SPI6_NSS0_Pin, GPIO_PIN_RESET);
#define CSHIGH() HAL_GPIO_WritePin(SPI6_NSS0_GPIO_Port, SPI6_NSS0_Pin, GPIO_PIN_SET);
